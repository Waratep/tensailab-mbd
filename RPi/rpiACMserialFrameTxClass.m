classdef rpiACMserialFrameTxClass < matlab.System ...
        & coder.ExternalDependency ...
        & matlab.system.mixin.Propagates ...
        & matlab.system.mixin.CustomIcon
    % rpiACMserialFrameTxClass  	Transmit data frame via ttyACM serial
    %#codegen
    ...
    methods
        % Constructor
        function obj = rpiACMserialFrameTxClass(varargin)
    ...
    methods(Access = protected)
        ...
        function stepImpl(obj, data)
            ...
            if coder.target('rtw')
                sz = length(data);
                coder.cinclude('rpiserial_wrapper.h');
                coder.ceval('rpi_ACMserial_FrameTransmit', coder.ref(data), uint8(sz), uint8(obj.SOFbyte), uint8(obj.EOFbyte));
            elseif ( coder.target('Sfun') )
    ...
    methods(Static)
        function name = getDescriptiveName()
            name = 'ttyACM Serial Frame Transmit';
        end

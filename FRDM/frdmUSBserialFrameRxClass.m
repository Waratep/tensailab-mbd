classdef frdmUSBserialFrameRxClass < matlab.System ...
        & coder.ExternalDependency ...
        & matlab.system.mixin.Propagates ...
        & matlab.system.mixin.CustomIcon
    % frdmUSBserialFrameRxClass     Extract data frame.
    %#codegen
    ...
    methods
        % Constructor
        function obj = frdmUSBserialFrameRxClass(varargin)
    ...
    methods(Access = protected)
        ...
        function [buffer, status] = stepImpl(obj)
            ...
            if coder.target('rtw')                             
                coder.cinclude('frdmserial_wrapper.h');
                status = coder.ceval('kl25z_USBserial_FrameReceive', coder.ref(buffer), uint8(obj.msgLen), uint8(obj.SOFbyte), uint8(obj.EOFbyte));
            elseif ( coder.target('Sfun') )

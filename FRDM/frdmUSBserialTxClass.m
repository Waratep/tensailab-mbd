classdef frdmUSBserialTxClass < matlab.System ...
        & coder.ExternalDependency ...
        & matlab.system.mixin.Propagates ...
        & matlab.system.mixin.CustomIcon
    % usbSerialTxClass  Transmit fixed-length data via USB serial
    %#codegen
    ...
    methods
        % Constructor
        function obj = frdmUSBserialTxClass(varargin)
    ...
    methods(Access = protected)
        ...
        function stepImpl(obj, data)
            ...
            if coder.target('rtw')
                sz = length(data);
                coder.cinclude('frdmserial_wrapper.h');
                coder.ceval('kl25z_USBserial_Transmit', data, sz);
            elseif ( coder.target('Sfun') )
